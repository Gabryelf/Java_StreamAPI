...
public class QueryBuilder {
     ...
     * @return
     */
    public String buildDeleteQuery(Class<?> clazz, UUID primaryKey) throws NoSuchFieldException {
        ...
        if (clazz.isAnnotationPresent(Table.class)) {
            ...
            if (primaryKeyField != null) {
                query.append(" WHERE ");
                query.append(primaryKeyField.getAnnotation(Column.class).name())
                        .append(" = '")
                        .append(primaryKey.toString())
                        .append("'");
            } else {
                throw new NoSuchFieldException("Primary key field not found");
            }
        } else {
